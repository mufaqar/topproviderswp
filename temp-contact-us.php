    ...
    <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 my-10 gap-10">
        <div>
            ...
            <div class="flex mt-8 items-center gap-4">
                <div class="bg-[#044FC3] p-4 rounded-xl">
                ...
                <div>
                    ...
                    <p class="">No: 58 A, East Madison Street, Baltimore, MD, USA 4508</p>
                </div>
            </div>

            <div class="flex mt-8 items-center gap-4">
                <div class="bg-[#044FC3] p-4 rounded-xl">
                    <svg fill="#fff" width="30px" height="30px" viewBox="0 -5 32 32" preserveAspectRatio="xMidYMid">
                ...
                <div>
                    <h3 class="font-bold text-2xl">Send us a mail</h3>
                    <p class="">info@topproviders.net</p>
                </div>
            </div>
            ...
            <div class="flex mt-8 items-center gap-4">
                ...
                <div>
                    ...
                    <p class="">000 - 123 - 456789</p>
                </div>
            </div>
           
        </div>
        <div class="w-full bg-blue-50 rounded-xl flex items-center justify-center">
